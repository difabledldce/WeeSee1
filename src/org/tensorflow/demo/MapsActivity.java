...
listen();
        ...
        private String getDirectionsUrl()
        {
            ...
            googleDirectionsUrl.append("&key="+"AIzaSyAUDi8r45Q35aBUDWYgEA0kq9YxHWHbqyQ");
        ...
        private String getUrl ( double latitude, double longitude, String nearbyPlace)
        {
            ...
            googlePlacesUrl.append("&key=" + "AIzaSyAUDi8r45Q35aBUDWYgEA0kq9YxHWHbqyQ");
    ...
    if (!location.equals("")) {
        ...
        if (addressList != null) {
            for (int i = 0; i < addressList.size(); i++) {
                ...
                markerOptions.position(latLng);
                mMap.addMarker(markerOptions);
speak("tap on center of the screen and then tap on bottom right corner of the screen and then double tap on bottom left corner of the screen");
